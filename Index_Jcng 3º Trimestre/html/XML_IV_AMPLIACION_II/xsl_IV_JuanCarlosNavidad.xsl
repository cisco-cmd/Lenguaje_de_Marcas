...
<html>
    ...
    <body>
        <header class="titulo"><img class="cabecera" src="img/streaming.png"/></header>
            ...
            <br/><br/><br/>
            <form action="alfabeto/xsl_IV_JuanCarlosNavidad.xml">
                <input type="submit" class="boton1" value="Ordenar alfabeticamente" />
            </form>
            </center>
        <br/>
        <hr class="hr1"/>
            <div class="opciones">
                ...
                <xsl:sort id="sort" select="valoracion" data-type="number" order="descending"/>
