...
-- Tiempo de generación: 02-11-2022 a las 09:24:46
...
CREATE TABLE IF NOT EXISTS `alquiler` (
  ...
  `Seguro` enum('S','N') COLLATE utf8mb4_spanish2_ci NOT NULL,
  `kms` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `clientes` (
  ...
  `tfno` varchar(9) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `sexo` enum('M','F') COLLATE utf8mb4_spanish2_ci NOT NULL,
  `f_nac` date NOT NULL,
...
CREATE TABLE IF NOT EXISTS `coches` (
  ...
  `Cod_color` varchar(2) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `f_matricula` date NOT NULL,
  `cod_tipo` varchar(2) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `cod_combustible` varchar(1) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `kms` int(11) NOT NULL,
...
INSERT INTO `coches` (`matricula`, `marca`, `modelo`, `Cod_color`, `f_matricula`, `cod_tipo`, `cod_combustible`, `kms`, `potencia`, `consumo`, `vmax`, `preciodia`) VALUES
('1138FZV', 'Porsche', 'Cayenne S', 'NE', '2007-10-15', 'SU', 'G', 734964, 462, '23.11', 245, '305.00'),
('1234HVD', 'Kia', 'Cee\'d', 'RO', '2017-12-26', 'TU', 'G', 10359, 186, '8.20', 182, '173.64'),
('1385HSG', 'Dacia', 'Duster', 'BL', '2016-11-22', 'TT', 'D', 28358, 75, '9.40', 142, '51.34'),
('2550KLP', 'Nissan', 'Leaf', 'BL', '2018-05-13', 'TU', 'E', 1980, 110, '0.00', 160, '65.00'),
('2550KLT', 'Nissan', 'Qashqai', 'NM', '2018-04-13', 'SU', 'D', 1980, 130, '5.50', 190, '56.00'),
('3070KZZ', 'Mini ', 'Cooper S', 'NM', '2020-12-20', 'DE', 'G', 3500, 180, '7.30', 225, '102.00'),
('3586HJR', 'Toyota', 'Aigo', 'BL', '2016-12-30', 'UT', 'H', 157438, 75, '4.83', 143, '57.46'),
('3661JJR', 'Seat', 'Ibiza', 'NE', '2018-07-27', 'UT', 'G', 11683, 112, '9.23', 172, '126.31'),
('3859JTF', 'Toyota', 'Prius', 'AM', '2018-02-19', 'BE', 'H', 63984, 136, '3.60', 157, '157.31'),
('3869HXT', 'Fiat', '500', 'AZ', '2017-12-20', 'UT', 'G', 63953, 65, '3.20', 136, '48.36'),
('3945JZF', 'Citroën', 'Berlingo', 'BL', '2018-08-31', 'FU', 'E', 38596, 110, '0.00', 110, '215.35'),
('4132GXD', 'Peugeot', 'Partner', 'VE', '2016-06-14', 'FU', 'D', 50683, 105, '5.00', 165, '80.00'),
('5385JYD', 'Mercedes-Benz', 'Clase A', 'RO', '2018-11-23', 'TU', 'D', 0, 214, '11.20', 183, '407.43'),
('6839HGL', 'Wolkswagen', 'Polo', 'BP', '2016-11-17', 'UT', 'D', 2439, 90, '6.40', 173, '91.12'),
('6930JVS', 'Ford', 'Fiesta', 'AZ', '2018-05-09', 'UT', 'D', 25483, 85, '6.78', 158, '78.82'),
('8345JGY', 'Chrysler', '300 Luxury ', 'NE', '2017-09-14', 'LI', 'D', 2034, 218, '11.03', 158, '247.00'),
('8348JFT', 'Mazda', '3', 'VE', '2018-07-12', 'TU', 'G', 4938, 190, '9.40', 207, '277.43');
...
CREATE TABLE IF NOT EXISTS `combustible` (
  `cod_combustible` enum('G','D','E','H','L') COLLATE utf8mb4_spanish2_ci NOT NULL,
  `descripcion` varchar(50) COLLATE utf8mb4_spanish2_ci NOT NULL,
