...
<html>
    <head>
        ...
        <meta charset="UTF-8"/>
        <link rel="stylesheet" type="text/css" href="EXLM2_JuanCarlosNavidad.css"/>
    </head>
    <body>
        <header>
            <center>
                ...
                <form action="Ordenado_Oscars/EXLM3_JuanCarlosNavidad.xml">
                    <br/><br/>
                    <input class="boton" type="submit" value="Ordenar por Oscar's"/>
                </form>
            </center>
        </header>
        <br/>
        ...
        <div class="oscars">
            <xsl:for-each select="pelicula">
                <xsl:sort data-type="number" order="descending" select="año"/>
                <div class="peliculas">
                    <a class="titulo">
